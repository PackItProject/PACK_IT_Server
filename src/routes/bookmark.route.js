...
//북마크에서 가게 접근
bookmarkRouter.get('/:pk_user/:store_id',getBookmarkedByStoreIdController);
bookmarkRouter.get('/:pk_user/:store_id/menu/:menu_id',getBookmarkedMenuIdController);
bookmarkRouter.get('/:pk_user/:store_id/meal',showBookmarkedMealController);
bookmarkRouter.get('/:pk_user/:store_id/side',showBookmarkedSideController);
